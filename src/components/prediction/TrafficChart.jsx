...
export default function TrafficChart({ trafficData, isLoading, component }) {
  if (isLoading) {
    return (
      <div className="flex flex-col rounded-2xl border border-slate-200 bg-card shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-5 min-h-[280px]">
  ...
  return (
    <div className="flex flex-col rounded-2xl border border-slate-200 bg-card shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden">
      {/* Header */}
