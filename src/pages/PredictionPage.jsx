              ...
              {topRisk.map(row => {
                ...
                return (
                  <div
                    ...
                    className="rounded-lg border border-line bg-muted/50 p-3 hover:border-indigo-300 transition-all text-left flex items-center justify-between cursor-pointer group"
                  >
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <ChevronRight size={12} className="text-ink-faint group-hover:text-indigo-500 transition-colors" />
                    </div>
                  </div>
                )
              })}
        ...
        <div className="rounded-xl border border-line bg-card shadow-card overflow-hidden">
          ...
          {summaryOpen && (
            <div className="border-t border-line px-5 py-4 bg-slate-50/50">
              {summaryLoading ? (
                <div className="flex items-center gap-2.5 text-ink-soft py-1">
