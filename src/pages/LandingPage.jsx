    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md overflow-hidden rounded-3xl border border-white/60 bg-white/80 p-8 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] backdrop-blur-xl animate-scale-up">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-emerald-50 border border-emerald-100 shadow-sm p-3">
          ...
          <form onSubmit={handleSubmit} className="w-full space-y-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 bg-white/50 py-3 pl-11 pr-4 text-sm text-ink placeholder-slate-400 focus:border-emerald-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-100 transition-all shadow-sm"
                required
              />
            </div>
            ...
            <button
              ...
              className="group relative w-full overflow-hidden rounded-xl bg-emerald-600 px-4 py-3 text-[14px] font-bold text-white shadow-md transition-all hover:bg-emerald-700 hover:shadow-lg active:scale-[0.98] disabled:opacity-70 mt-2 cursor-pointer"
            >
...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-slate-50 selection:bg-emerald-100 selection:text-emerald-900">
      {/* Background Ambient Glows (Matching logo theme) */}
      <div className="absolute top-0 -left-[10%] h-[50vw] w-[50vw] rounded-full bg-emerald-100/40 blur-[100px]" />
      <div className="absolute top-[40%] -right-[10%] h-[40vw] w-[40vw] rounded-full bg-teal-50/50 blur-[100px]" />
      
      {/* Subtle Grid Pattern */}
      <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-60 mask-image:linear-gradient(to_bottom,transparent,black,transparent)" />
      ...
      <nav className="relative z-10 flex items-center justify-between px-8 py-6 md:px-16 md:py-8">
        ...
        <button 
          ...
          className="rounded-full border border-slate-200 bg-white px-6 py-2.5 text-sm font-semibold text-slate-700 shadow-sm transition-all hover:border-brand/40 hover:text-brand cursor-pointer"
        >
          Sign In
        </button>
      </nav>
      ...
      <main className="relative z-10 flex min-h-[80vh] flex-col items-center justify-center px-4 text-center">
        <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-emerald-200/60 bg-emerald-50 px-4 py-1.5 text-[13px] font-bold text-emerald-700">
        ...
        <h1 className="mb-6 max-w-4xl text-5xl font-extrabold tracking-tight text-ink sm:text-7xl">
          ...
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-emerald-600 to-teal-500">Complex Architectures</span>
        </h1>
        ...
        <div className="flex flex-col gap-4 sm:flex-row">
          <button 
            onClick={() => setIsLoginModalOpen(true)}
            className="group flex items-center justify-center gap-2 rounded-xl bg-emerald-600 px-8 py-4 text-base font-bold text-white shadow-lg shadow-emerald-100 transition-all hover:bg-emerald-700 hover:shadow-xl active:scale-[0.98] cursor-pointer"
          >
            Launch Dashboard
        ...
        <div className="mt-20 flex flex-wrap justify-center gap-6">
          ...
          <div className="flex items-center gap-2 rounded-lg border border-slate-200 bg-white/60 px-4 py-2 text-sm font-semibold text-slate-600 backdrop-blur-sm">
            <Shield size={16} className="text-emerald-500" /> Autonomous Remediation
          </div>
          <div className="flex items-center gap-2 rounded-lg border border-slate-200 bg-white/60 px-4 py-2 text-sm font-semibold text-slate-600 backdrop-blur-sm">
